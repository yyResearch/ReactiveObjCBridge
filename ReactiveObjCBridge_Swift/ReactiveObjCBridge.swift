...
public extension SignalProducerProtocol where Value: AnyObject {
...
public extension SignalProducerProtocol where Value: OptionalProtocol, Value.Wrapped: AnyObject {
   /// A bridged `RACSignal` that will `start()` the producer once for each subscription.
   ///
   /// - note: Any `interrupted` events will be silently discarded.
   ///
...
public extension SignalProtocol where Value: AnyObject {
...
public extension SignalProtocol where Value: OptionalProtocol, Value.Wrapped: AnyObject {
   /// A bridged `RACSignal` that will observe the given signal.
   ///
   /// - note: Any `interrupted` events will be silently discarded.
   ///
